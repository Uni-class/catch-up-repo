const tokens = {
  ...
  "colors.google.base.text": {
    "value": "#000000",
    "variable": "var(--colors-google-base-text)"
  },
  "colors.google.base": {
    "value": "#ffffff",
    "variable": "var(--colors-google-base)"
  },
  "colors.google.emphasize.text": {
    "value": "#000000",
    "variable": "var(--colors-google-emphasize-text)"
  },
  "colors.google.emphasize": {
    "value": "#d6d6d6",
    "variable": "var(--colors-google-emphasize)"
  },
  "colors.google.dark.text": {
    "value": "#ffffff",
    "variable": "var(--colors-google-dark-text)"
  },
  "colors.google.dark": {
    "value": "#393939",
    "variable": "var(--colors-google-dark)"
  },
  "colors.naver.base.text": {
    "value": "#ffffff",
    "variable": "var(--colors-naver-base-text)"
  },
  "colors.naver.base": {
    "value": "#03c75a",
    "variable": "var(--colors-naver-base)"
  },
  "colors.naver.emphasize.text": {
    "value": "#ffffff",
    "variable": "var(--colors-naver-emphasize-text)"
  },
  "colors.naver.emphasize": {
    "value": "#00923a",
    "variable": "var(--colors-naver-emphasize)"
  },
  "colors.naver.dark.text": {
    "value": "#ffffff",
    "variable": "var(--colors-naver-dark-text)"
  },
  "colors.naver.dark": {
    "value": "#007132",
    "variable": "var(--colors-naver-dark)"
  },
  "colors.kakao.base.text": {
    "value": "#000000",
    "variable": "var(--colors-kakao-base-text)"
  },
  "colors.kakao.base": {
    "value": "#fee500",
    "variable": "var(--colors-kakao-base)"
  },
  "colors.kakao.emphasize.text": {
    "value": "#000000",
    "variable": "var(--colors-kakao-emphasize-text)"
  },
  "colors.kakao.emphasize": {
    "value": "#ddc400",
    "variable": "var(--colors-kakao-emphasize)"
  },
  "colors.kakao.dark.text": {
    "value": "#000000",
    "variable": "var(--colors-kakao-dark-text)"
  },
  "colors.kakao.dark": {
    "value": "#b39200",
  ...
  "fonts.Pretendard": {
    "value": "var(--font-pretendard), sans-serif",
  ...
  "colors.colorPalette.base.text": {
    "value": "var(--colors-color-palette-base-text)",
    "variable": "var(--colors-color-palette-base-text)"
  },
  ...
  "colors.colorPalette.emphasize.text": {
    "value": "var(--colors-color-palette-emphasize-text)",
    "variable": "var(--colors-color-palette-emphasize-text)"
  },
  "colors.colorPalette.emphasize": {
    "value": "var(--colors-color-palette-emphasize)",
    "variable": "var(--colors-color-palette-emphasize)"
  },
